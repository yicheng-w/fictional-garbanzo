...
flags.DEFINE_string("embedding_file", "data/glove.6B.100d.txt",
        "Embeddings file")
flags.DEFINE_string("data_root", "./aclImdb", "Data dir")
...
flags.DEFINE_integer("max_iterations", 500, "Max question iterations")
...
flags.DEFINE_integer("hidden_size_encoder", 64, "Encoder hidden size")
flags.DEFINE_integer("hidden_size", 128, "projection hidden size")
...
flags.DEFINE_integer("min_occurence", 15,
...
flags.DEFINE_string("dataset", "20newsgroups", "dataset to use")
